#
#  Be sure to run `pod spec lint DBNetworkStack.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.authors            = { "Lukas Schmidt" => "lukas.la.schmidt@deutschebahn.com", "Christian Himmelsbach" => "christian.himmelsbach@deutschebahn.com" }
  s.social_media_url   = "http://twitter.com/lightsprint09"
  ...
  s.source       = { :git => "https://github.com/dbsystel/DBNetworkStack.git", :tag => "#{s.version}" }
